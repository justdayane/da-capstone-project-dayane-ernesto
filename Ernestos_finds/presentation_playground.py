...
""")
    ...
    with col1:
        st.image(process_image("../../Streamlit/matcha_Z.jpeg"))

    with col2:
        st.image(process_image("../../Streamlit/sober_rave.jpg"))

    with col3:
        st.image(process_image("../../Streamlit/therapy_Z.jpeg"))
...
# Slope chart, generation snapshot for 2010 and 2019
    ...
    yaxis=dict(
        ...
        rangemode='tozero'  # 20% headroom above max value
    ),
